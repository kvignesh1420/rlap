            ...
            for filepath in filepaths:
                ...
                with open(filepath, "r") as fh:
                    ...
                    table_entries.append({
                            ...
                            "lr": lr,
                            "wd": wd,
                            "F1Mi": r"${} \pm {}$".format(np.round(np.mean(f1mi_scores),2), np.round(np.std(f1mi_scores),2)),
                            "F1Ma": r"${} \pm {}$".format(np.round(np.mean(f1ma_scores),2), np.round(np.std(f1ma_scores),2)),
                            "acc": r"${} \pm {}$".format(np.round(np.mean(acc_scores),2), np.round(np.std(acc_scores),2)),
                        })
